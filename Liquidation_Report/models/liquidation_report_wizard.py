...
class LiquidationReportWizard(models.TransientModel):
    ...
    company_license_number = fields.Char(
        ...
        compute='_compute_company_license_number',
    ...
    @api.depends('company_id')
    def _compute_company_license_number(self):
        for rec in self:
            rec.company_license_number = getattr(rec.company_id, 'company_license_number', False)
