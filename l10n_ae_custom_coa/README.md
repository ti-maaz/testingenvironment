...
- Keeps UAE tax configuration unchanged by reading tax/fiscal-position templates from `l10n_ae`.
- Remaps UAE tax/system account references to your custom `ae_custom_account_*` XMLIDs.
- For `ae_custom`, disables Odoo auto-generated utility accounts and binds utility settings to your codes:
  - Suspense: `12040209`
...
- Enforces strict account synchronization through `_sync_ae_custom_coa`:
  ...
  - preserve referenced/system-linked accounts only
...
- Restore from database backup when available.
