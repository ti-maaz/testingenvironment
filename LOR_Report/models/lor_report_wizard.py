...
class LorReportWizard(models.TransientModel):
    ...
    incorporation_date = fields.Date(string='Company Incorporation Date', compute='_compute_company_exte_scalar_fields', inverse='_inverse_incorporation_date', store=False)
    corporate_tax_registration_number = fields.Char(string='Corporate Tax Registration Number', compute='_compute_company_exte_scalar_fields', inverse='_inverse_corporate_tax_registration_number', store=False)
    vat_registration_number = fields.Char(string='VAT Registration Number', compute='_compute_company_exte_scalar_fields', inverse='_inverse_vat_registration_number', store=False)
    corporate_tax_start_date = fields.Date(string='Corporate Tax Start Date', compute='_compute_company_exte_scalar_fields', inverse='_inverse_corporate_tax_start_date', store=False)
    corporate_tax_end_date = fields.Date(string='Corporate Tax End Date', compute='_compute_company_exte_scalar_fields', inverse='_inverse_corporate_tax_end_date', store=False)
    implementing_regulations_freezone = fields.Text(string='Implementing Regulations for Free Zones', compute='_compute_company_exte_scalar_fields', inverse='_inverse_implementing_regulations_freezone', store=False)
